...
2. Connect to it, open `http://192.168.4.1/` (or just wait for the captive
   portal prompt).
3. Fill in your WiFi network, your chess.com `PHPSESSID` cookie (from your
   browser's DevTools → Application → Cookies, while logged into
   chess.com), and your chess.com username. Save - it restarts to join
   your WiFi.
